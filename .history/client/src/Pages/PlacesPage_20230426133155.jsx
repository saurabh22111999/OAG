            ...
            <div>
                ...
                {preInput('Bid start and Bid end','Add bid')}
                    ...
                    <div className="grid  gap-2 sm:grid-cols-3">
                        ...
                        <h3>Start bid</h3>
                            <input type="text" placeholder="INR" value={startbid} onChange={ev=>setStartbid(ev.target.value)}/>
                        </div>
                        <div className="mt-2 -mb-1">
                        <h3>End bid</h3>
                            <input type="text" placeholder="INR" value={endbid} onChange={ev=>setEndbid(ev.target.value)}/>
                        </div>
                        <div className="mt-2 -mb-1">
                        <h3>Max bids</h3>
                            <input type="text" placeholder="Number" value={maxbid} onChange={ev=>setMaxbid(ev.target.value)}/>
                        </div>
                    </div>
